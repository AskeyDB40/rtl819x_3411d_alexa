...
ifneq ($(CONFIG_AUDIO_SINK_SUPPORT),y)
ifneq ($(CONFIG_AUDIO_SINK_PLAYER_SUPPORT),y)
ifneq ($(CONFIG_AUDIO_SINK_CONFIG_SUPPORT),y)
ifeq ($(CONFIG_IPV6),y)
...
ifeq ($(CONFIG_SND_USB_AUDIO),y)
	PLATFORM_COMMON_CFLAGS += -DCONFIG_SND_USB_AUDIO
	COMMON_CFLAGS += -DCONFIG_SND_USB_AUDIO
endif

ifeq ($(CONFIG_SND_RTL819XD_SOC_I2S),y)
	PLATFORM_COMMON_CFLAGS += -DCONFIG_SND_RTL819XD_SOC_I2S
	COMMON_CFLAGS += -DCONFIG_SND_RTL819XD_SOC_I2S
endif

ifeq ($(CONFIG_AUDIO_SINK_SUPPORT),y)
	COMMON_CFLAGS += -DCONFIG_AUDIO_SINK_SUPPORT
	PLATFORM_COMMON_CFLAGS += -DCONFIG_AUDIO_SINK_SUPPORT
endif
