...
/**
 * soup_client_context_get_host_ip:
 * @client: a #SoupClientContext
 *
 ...
 *
 * Return value: 0 fail to retrieve ip addess, 1 success to retrieve ip address
 * 
 **/
int
soup_client_context_get_host_ip (SoupClientContext *client, char *dest_buf)
{
	
	if(client == NULL)
		return 0;
		
	soup_socket_get_remote_ip_address (client->sock, dest_buf);
	if(dest_buf[0])
		return 1;
	else
		return 0;
