/* rygel-tracker-albums.c generated by valac 0.16.1, the Vala compiler
...
RygelTrackerAlbums* rygel_tracker_albums_construct (GType object_type, RygelTrackerMusic* parent) {
	...
	_tmp2_ = g_strconcat (_tmp1_, "Albums", NULL);
	_tmp3_ = _tmp2_;
	_tmp4_ = parent;
	_tmp5_ = _ ("Albums");
	_tmp6_ = parent;
	_tmp7_ = ((RygelTrackerCategoryContainer*) _tmp6_)->item_factory;
	self = (RygelTrackerAlbums*) rygel_tracker_metadata_values_construct (object_type, _tmp3_, (RygelMediaContainer*) _tmp4_, _tmp5_, _tmp7_, "upnp:album", RYGEL_MEDIA_CONTAINER_MUSIC_ALBUM);
	_g_free0 (_tmp3_);
	return self;
}
