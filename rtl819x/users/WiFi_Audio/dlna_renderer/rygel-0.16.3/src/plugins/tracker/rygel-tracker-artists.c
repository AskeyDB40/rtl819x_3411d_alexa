/* rygel-tracker-artists.c generated by valac 0.16.1, the Vala compiler
 * generated from rygel-tracker-artists.vala, do not modify */
...
typedef struct _RygelTrackerArtistsPrivate RygelTrackerArtistsPrivate;
...
struct _RygelTrackerArtists {
	RygelTrackerMetadataValues parent_instance;
	RygelTrackerArtistsPrivate * priv;
};

struct _RygelTrackerArtistsClass {
...
static gpointer rygel_tracker_artists_parent_class = NULL;
...
enum  {
	RYGEL_TRACKER_ARTISTS_DUMMY_PROPERTY
};
...
RygelTrackerArtists* rygel_tracker_artists_construct (GType object_type, RygelTrackerMusic* parent) {
	...
	_tmp2_ = g_strconcat (_tmp1_, "Artists", NULL);
	_tmp3_ = _tmp2_;
	_tmp4_ = parent;
	_tmp5_ = _ ("Artists");
	_tmp6_ = parent;
	_tmp7_ = ((RygelTrackerCategoryContainer*) _tmp6_)->item_factory;
	self = (RygelTrackerArtists*) rygel_tracker_metadata_values_construct (object_type, _tmp3_, (RygelMediaContainer*) _tmp4_, _tmp5_, _tmp7_, "upnp:artist", RYGEL_MEDIA_CONTAINER_MUSIC_ARTIST);
	_g_free0 (_tmp3_);
	return self;
}
...
RygelTrackerArtists* rygel_tracker_artists_new (RygelTrackerMusic* parent) {
	return rygel_tracker_artists_construct (RYGEL_TRACKER_TYPE_ARTISTS, parent);
}


static void rygel_tracker_artists_class_init (RygelTrackerArtistsClass * klass) {
	rygel_tracker_artists_parent_class = g_type_class_peek_parent (klass);
}


static void rygel_tracker_artists_instance_init (RygelTrackerArtists * self) {
}
 ...
 */
GType rygel_tracker_artists_get_type (void) {
	static volatile gsize rygel_tracker_artists_type_id__volatile = 0;
	if (g_once_init_enter (&rygel_tracker_artists_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (RygelTrackerArtistsClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) rygel_tracker_artists_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (RygelTrackerArtists), 0, (GInstanceInitFunc) rygel_tracker_artists_instance_init, NULL };
		GType rygel_tracker_artists_type_id;
		rygel_tracker_artists_type_id = g_type_register_static (RYGEL_TRACKER_TYPE_METADATA_VALUES, "RygelTrackerArtists", &g_define_type_info, 0);
		g_once_init_leave (&rygel_tracker_artists_type_id__volatile, rygel_tracker_artists_type_id);
	}
	return rygel_tracker_artists_type_id__volatile;
}
