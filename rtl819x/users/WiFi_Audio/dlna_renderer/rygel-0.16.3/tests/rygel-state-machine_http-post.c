/* rygel-state-machine_http-post.c generated by valac 0.16.1, the Vala compiler
...
void rygel_state_machine_run (RygelStateMachine* self, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 27 "/home/jens/Source/rygel/tests/rygel-state-machine_http-post.vala"
	RYGEL_STATE_MACHINE_GET_INTERFACE (self)->run (self, _callback_, _user_data_);
#line 61 "rygel-state-machine_http-post.c"
}
...
#line 68 "rygel-state-machine_http-post.c"
}


GCancellable* rygel_state_machine_get_cancellable (RygelStateMachine* self) {
#line 32 "/home/jens/Source/rygel/tests/rygel-state-machine_http-post.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 32 "/home/jens/Source/rygel/tests/rygel-state-machine_http-post.vala"
	return RYGEL_STATE_MACHINE_GET_INTERFACE (self)->get_cancellable (self);
#line 77 "rygel-state-machine_http-post.c"
}
...
#line 86 "rygel-state-machine_http-post.c"
}
...
#line 101 "rygel-state-machine_http-post.c"
	}
}
