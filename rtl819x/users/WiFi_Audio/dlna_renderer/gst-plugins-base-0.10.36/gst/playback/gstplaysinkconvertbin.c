    ...
    GstPlaySinkConvertBin * self)
{
  ...
  gst_object_unref (element);////Patch from 	5462536a36f4bd78950298a694ced44468e6b4ae
...
//      (GDestroyNotify) gst_object_unref);
      (GstPadBlockCallback) pad_blocked_cb, self, NULL);//Patch from 9fc640b9e0ba807b7f8ce6bdbd7c754bdbfdb761
