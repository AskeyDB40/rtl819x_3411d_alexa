...
#define DEFAULT_BUFFER_DURATION   1500000000 //ns
#else
#define DEFAULT_BUFFER_DURATION   3 * GST_SECOND
#endif
...
//   g_warning("%s, %s, %d,set new uri to %s",__FILE__, __FUNCTION__, __LINE__, uri);
...
g_warning("%s, %s, %d,setting new .sub uri to %s",__FILE__, __FUNCTION__, __LINE__, suburi);
  GST_PLAY_BIN_UNLOCK (playbin);
}
