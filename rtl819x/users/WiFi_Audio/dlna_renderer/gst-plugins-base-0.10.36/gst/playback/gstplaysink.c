...
setup_audio_chain (GstPlaySink * playsink, gboolean raw)
{
  ...
  GstPlayAudioChain *chain;
  GstStateChangeReturn ret;
	GstPlaySinkAudioConvert *conv;//Patch from 	b2a162ca771fd3969207028190b2c3166da5c171
  chain = playsink->audiochain;
conv = GST_PLAY_SINK_AUDIO_CONVERT_CAST (chain->conv); //Patch from 	b2a162ca771fd3969207028190b2c3166da5c171
  chain->chain.raw = raw;
...
//Patch from    	b2a162ca771fd3969207028190b2c3166da5c171
//  } else {
//    GstPlaySinkAudioConvert *conv =
//        GST_PLAY_SINK_AUDIO_CONVERT_CAST (chain->conv);
} else if (conv) { 
...
gst_pad_set_blocked_async (opad, FALSE, sinkpad_blocked_cb, playsink); //Patch from 9fc640b9e0ba807b7f8ce6bdbd7c754bdbfdb761
...
//          gst_object_ref (playsink), (GDestroyNotify) gst_object_unref);
gst_pad_set_blocked_async (opad, TRUE, sinkpad_blocked_cb, playsink); //Patch from 9fc640b9e0ba807b7f8ce6bdbd7c754bdbfdb761
      gst_object_unref (opad);
    }
...
//          gst_object_ref (playsink), (GDestroyNotify) gst_object_unref);
gst_pad_set_blocked_async (blockpad, TRUE, sinkpad_blocked_cb, playsink);//Patch from 9fc640b9e0ba807b7f8ce6bdbd7c754bdbfdb761
