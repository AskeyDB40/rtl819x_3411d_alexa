/* testhashmultimap.c generated by valac 0.15.0.90-e9553, the Vala compiler
...
static void hash_multi_map_tests_test_selected_functions (HashMultiMapTests* self) {
	...
	_tmp1_ = _g_object_ref0 (GEE_IS_HASH_MULTI_MAP (_tmp0_) ? ((GeeHashMultiMap*) _tmp0_) : NULL);
	test_hash_multi_map = _tmp1_;
	g_assert (test_hash_multi_map != NULL);
