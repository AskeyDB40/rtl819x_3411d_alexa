...
//Patch from 	031514faebdcaeb05e6c6625d6152f122af1ed6e  	
...
gst_registry_binary_cache_finish (BinaryRegistryCache * cache, gboolean success)
{
  ...
  if (close (cache->cache_fd) < 0)
    goto close_failed;
//Patch from 	c25b8e153d4515b42f9e522de8655460d5cde1dc
//  if (success) {
...
//Patch end from 	c25b8e153d4515b42f9e522de8655460d5cde1dc 
  g_free (cache->tmp_location);
  g_slice_free (BinaryRegistryCache, cache);
