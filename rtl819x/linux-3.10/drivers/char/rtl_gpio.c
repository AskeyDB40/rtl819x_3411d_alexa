...
#if 1 //!defined(CONFIG_AUDIO_SINK_SUPPORT) && !defined(CONFIG_SND_RTL819XD_SOC_I2S)
#define AUTO_CONFIG
#endif
/*
...
int __init rtl_gpio_init(void)
{
    ...
    #endif
#endif /* AUTO_CONFIG */
#if 0 //!defined(AUTO_CONFIG) && defined(CONFIG_AUDIO_SINK_SUPPORT) && defined(CONFIG_SND_RTL819XD_SOC_I2S)
...
#if 0 //defined(CONFIG_AUDIO_SINK_SUPPORT) && defined(CONFIG_SND_RTL819XD_SOC_I2S)
	if(!strcmp(pdata->name, "wps btn"))
		return 0;
#endif	
